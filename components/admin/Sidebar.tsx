        ...
        {links.map((link) => {
          ...
          return (
            <Link 
              key={link.name} 
              href={link.href}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-all duration-300 group ${active ? 'bg-white/10 text-white' : 'text-[#888888] hover:bg-white/5 hover:text-white'}`}
            >
