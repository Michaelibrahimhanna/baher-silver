...
export function ProductCard({
  ...
  return (
    ...
    >
      {/* Image Container */}
      <div className="relative aspect-[3/4] w-full overflow-hidden bg-secondary/50 mb-6">
        {product.isNew && (
          <div className="absolute top-4 left-4 z-10">
            <span className="text-[10px] tracking-[0.2em] uppercase font-medium text-primary/80 bg-background/50 backdrop-blur-md px-3 py-1">
              {dict.new_arrivals?.title || 'New'}
            </span>
          </div>
        )}
        ...
        <div className="absolute inset-0 bg-black/0 transition-colors duration-700 ease-out group-hover:bg-black/20" />
