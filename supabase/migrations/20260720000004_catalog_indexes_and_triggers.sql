...
CREATE TRIGGER audit_brands AFTER INSERT OR UPDATE OR DELETE ON brands FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_materials AFTER INSERT OR UPDATE OR DELETE ON materials FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_collections AFTER INSERT OR UPDATE OR DELETE ON collections FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_warehouses AFTER INSERT OR UPDATE OR DELETE ON warehouses FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_inventory_ledger AFTER INSERT OR UPDATE OR DELETE ON inventory_ledger FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_attributes AFTER INSERT OR UPDATE OR DELETE ON attributes FOR EACH ROW EXECUTE FUNCTION log_audit_event();
CREATE TRIGGER audit_attribute_values AFTER INSERT OR UPDATE OR DELETE ON attribute_values FOR EACH ROW EXECUTE FUNCTION log_audit_event();
